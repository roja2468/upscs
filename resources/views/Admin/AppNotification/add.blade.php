...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Add App Notification</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active">Add App Notification</li>
            </ol>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="m-t-40" method="post" action="{{route('admin.app_notification.save')}}" id="add_faq" enctype="multipart/form-data">
                    	@csrf
                        ...
                        <div class="form-group m-b-40">
                            ...
                            <input id="notification_date" class="form-control singledate" name="notification_date" data-toggle="tooltip" data-placement="bottom" title="Notification Date" />
