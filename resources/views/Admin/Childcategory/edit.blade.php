...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Edit Child Category</h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="m-t-40" method="post" action="{{route('admin.child_categories.update',$category->id)}}" id="edit_category" enctype="multipart/form-data">
                    	@csrf

                        <div class="form-group m-b-40">
                            <label for="title">Category</label>
                            <select class="select2 m-b-10 form-control" title="Select Parent!" style="width: 100%" name="parent_category">
                        ...
                        <div class="form-group m-b-40">
                            ...
                            <select class="select2 m-b-10 form-control" title="Select Sub Parent!" style="width: 100%" name="sub_category">
                                <option value="">-select sub category-</option>
                                @foreach($subCategory as $value)
                                    <option value="{{$value->id}}" {{ ($category->sub_parent_id==$value->id)?"Selected":"" }}>{{$value->title}}</option>
                                @endforeach
                            </select>
                            <span class="bar"></span>
                            @error('sub_category')
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <a href="{{route('admin.child_categories.list')}}" class="btn btn-inverse">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
