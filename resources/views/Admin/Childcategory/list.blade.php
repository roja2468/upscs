...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Child Category</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-md-7 col-4 align-self-center">
            <div class="d-flex m-t-10 justify-content-end">
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
        			<a href="{{route('admin.child_categories.add')}}" class="btn btn-success">Add Child Category</a>                    
                </div>
            </div>
        </div>
    </div>
	...
	$(document).ready(function() {
	    ...
	    table = $('#editable-datatable').dataTable({
	        ...
	        ajax:{
	            ...
	            url:'{!! route("admin.child_categories.data") !!}',
	            type:'POST'
	        },
	        columns: [
	            {data: 'id',name: 'id'},
	            {data: 'parent_id',name: 'parent_id'},
	            {data: 'sub_parent_id',name: 'sub_parent_id'},
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
				    type: "POST",
				    headers: {'X-CSRF-Token': Laravel.csrfToken},
				    url: '{{ route("admin.child_categories.delete") }}',
				    dataType : 'json',
				    data: {id:id},
				    success: function(response) {
				    	if(response.succsess == true){
					        ...
					        Swal.fire(
	        				  'Child Category could not delete!',
