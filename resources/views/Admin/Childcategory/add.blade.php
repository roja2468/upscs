...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Add Child Category</h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="m-t-40" method="post" action="{{route('admin.child_categories.save')}}" id="add_category" enctype="multipart/form-data">
                    	@csrf
        ...
        $('#add_category').validate({
            ...
            rules: {
                ...
                title:{
                    required:true,
                    remote: {
                        url : "{!! route('admin.child_categories.unique') !!}",
                        data: {
                            title: function () {
            ...
            messages: {
                ...
                sub_category: {
                    required:"Please select sub parent category",
                },
                title:{
