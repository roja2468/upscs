...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Demo Video</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-md-7 col-4 align-self-center">
            <div class="d-flex m-t-10 justify-content-end">
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
        			<a href="{{route('admin.demo.video.add')}}" class="btn btn-success">Add Demo Video</a>
        		</div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    table = $('#editable-datatable').dataTable({
	        ...
	        ajax:{
	            ...
	            url:'{!! route("admin.demo.video.data") !!}',
	            type:'POST'
	        },
	        columns: [
	            {data: 'id',name: 'id'},
	...
	function change_active(ele,id)
	{
	    ...
	    $.ajax({
	        type: "POST",
	        headers: {'X-CSRF-Token': Laravel.csrfToken},
	        url: '{{ route("admin.demo.video.change_active_status") }}',
	        dataType : 'json',
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
				    type: "POST",
				    headers: {'X-CSRF-Token': Laravel.csrfToken},
				    url: '{{ route("admin.demo.video.delete") }}',
				    dataType : 'json',
				    data: {id:id},
				    success: function(response) {
				    	if(response.succsess == true)
