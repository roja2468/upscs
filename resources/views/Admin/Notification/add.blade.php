...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Send Push Notification</h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="m-t-40" method="post" action="{{route('admin.notification.sendPushNotification')}}" id="send_push_notification_form" enctype="multipart/form-data">
                    	@csrf
                        ...
                        <div id="users_selection" class="form-group m-b-40 hidden">
                            ...
                            <select style="width: 100%" multiple="" id="user_list" class="select2 m-b-10 form-control" title="Select Users!" name="user_id[]">
