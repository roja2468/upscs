            ...
            <div class="card">
                <div class="card-body">
                    <form class="m-t-40" method="post" action="{{route('admin.topic.video.save')}}" id="add_topic" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-b-40" id="new" style="display:none;">
                            ...
                            <!--<select class="select2 m-b-10 form-control" onchange="videotype()" id="video_type" name="video_type" data-toggle="tooltip" data-placement="bottom" title="Select video type!">
                                ...
                                @foreach($VideoTypes as $key => $vide)
                                <option value="{{$vide->vid_id}}">{{$vide->videotype_name}}</option>
                                @endforeach
                            </select>-->
                            <select class="select2 m-b-10 form-control" onchange="videotype()" id="video_type" name="video_type" data-toggle="tooltip" data-placement="bottom" title="Select video type!">
                                <option value="">-select Video Type-</option>
                                <option value="1">Server Video</option>
                                <option value="2">Youtube Id</option>
                            </select>
                            <span class="bar"></span>
                            @error('video_type')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group m-b-40" id="youtube" style="display:none;">
                            <label for="video">Topic Video Id</label>
                            <input type="text" class="form-control" disabled="disabled" onkeyup="GetYoutubeVideo(this);" name="video" id="video" value="{{ old('video') }}" data-toggle="tooltip" data-placement="bottom" title="Enter Topic Video Id!">
                            <iframe width="500" class="ifram_section" style="display: none;margin-top: 10px;" height="315" src="" onerror="BlankIframe(this);"></iframe> 
                            <span class="bar"></span>
                            @error('video')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group m-b-40" id="server" style="display:none;">
                            <label for="video">Topic Video file</label>
                            <input type="file" class="form-control" name="video" disabled="disabled" id="GetserverVideo" accept="video/*" value="{{ old('video') }}" data-toggle="tooltip" data-placement="bottom" title="Enter Topic Video Id!">
                            <video width="500" controls style="margin-top: 10px;" height="315"><source src="mov_bbb.mp4" id="video_here">Your browser does not support HTML5 video.</video> 
                            <span class="bar"></span>
                            @error('video')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('video') }}</strong>
                        ...
                        <div class="form-group m-b-40" id="Existing" style="display:none;">
                            ...
                            <select class="select2 m-b-10 form-control" id="videop" name="videop" data-toggle="tooltip" data-placement="bottom" title="Select Topic!">
