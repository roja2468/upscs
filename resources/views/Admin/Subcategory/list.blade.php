        ...
        <div class="col-md-7 col-4 align-self-center">
            <div class="d-flex m-t-10 justify-content-end">
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
        			<a href="{{route('admin.sub_categories.add')}}" class="btn btn-success">Add Sub Category</a>                    
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	...
	function delete_confirmation(ele,id){
		...
		Swal.fire({
			...
			text: "All child categories attached to this category will be deleted. You won't be able to revert this!",
			type: 'warning',
			...
			if (result.value) {
				$.ajax({
				    type: "POST",
				    headers: {'X-CSRF-Token': Laravel.csrfToken},
				    url: '{{ route("admin.sub_categories.delete") }}',
				    dataType : 'json',
				    data: {id:id},
